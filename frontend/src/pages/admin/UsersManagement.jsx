          ...
          <form onSubmit={handleCreate} className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <input name="password" type={showPassword ? "text" : "password"} value={form.password} onChange={handleChange} required minLength={6} placeholder="Minimal 6 karakter" className={`${inputClass} pr-11`} />
            ...
            <div>
              ...
              <div className="relative">
                <input name="confirmPassword" type={showConfirmPassword ? "text" : "password"} value={form.confirmPassword} onChange={handleChange} required minLength={6} placeholder="Ulangi password" className={`${inputClass} pr-11`} />

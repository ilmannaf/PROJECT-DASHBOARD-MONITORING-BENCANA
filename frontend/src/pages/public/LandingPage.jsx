...
function FotoHighlight() {
  ...
  const getCardTransform = (idx) => {
    ...
    if (absDiff === 1) {
      const dragOffset = isDragging
        ? (dragDelta / (containerRef.current?.offsetWidth || 1)) * 30 * sign
        : 0;
      return {
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse at center, rgba(120,53,15,0.15) 0%, rgba(17,24,39,1) 70%)",
      }}
    >
      ...
      <div className="p-3">
        ...
        <div className="mt-1.5 flex items-center gap-1.5">
          <span className="flex h-6 w-6 items-center justify-center rounded-md bg-gray-100">
            {disasterIconMap[latest.disaster_type] || (
              <Zap className="h-4 w-4 text-gray-500" />
            )}
          </span>
          <span className="text-[13px] font-semibold text-gray-900 truncate">
            {latest.disaster_type}
          </span>
        </div>
        <div className="mt-2 flex items-center gap-1.5">
          <span
            className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold ${sc.bg} ${sc.text}`}
          >
...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      document
        .querySelectorAll(
          ".hero-badge, .hero-subtitle, .hero-title, .hero-desc, .hero-btn",
        )
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="mx-auto w-full max-w-7xl px-6 pb-16 sm:px-8 lg:px-12">
            <div className="max-w-2xl space-y-5">
              <div className="hero-badge inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 backdrop-blur-sm">
              ...
              <p className="hero-subtitle text-sm font-semibold uppercase tracking-[0.2em] text-orange-200 sm:text-base">
                Sistem Pelaporan dan Monitoring Bencana
              </p>

              <h1 className="hero-title text-5xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-6xl lg:text-7xl">
                BPBD Kota Semarang
              </h1>

              <p className="hero-desc max-w-lg text-[15px] leading-relaxed text-white/70 sm:text-base">
                Laporkan kejadian bencana secara cepat dan akurat. Pantau
                status penanganan secara real-time.
              </p>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="reveal mb-12 text-center">
            ...
            <p className="mx-auto max-w-lg text-sm text-gray-500">
              Sistem monitoring kebencanaan yang mudah dan cepat untuk warga
              Kota Semarang.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-500 via-brand-600 to-orange-500 py-20 text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            >
              <svg
                className="h-4 w-4 text-brand-600 transition-transform group-hover:-rotate-12"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                strokeWidth={2}
      ...
      >
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-red-500/20 bg-gradient-to-br from-red-500/15 to-red-600/10 p-6 backdrop-blur-sm">
                ...
                <div className="relative">
                  ...
                  <p className="mt-1 text-sm text-gray-400">
                    Nomor darurat nasional — hubungi segera saat bencana
                  </p>
            ...
            <div
              className="reveal overflow-hidden rounded-2xl border border-white/10 shadow-lg shadow-black/20"
              style={{ minHeight: 380 }}
            >
              <iframe

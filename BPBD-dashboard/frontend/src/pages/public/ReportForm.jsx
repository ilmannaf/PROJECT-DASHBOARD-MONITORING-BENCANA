    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white shadow rounded-xl p-8 max-w-sm w-full text-center">
          ...
          <p className="text-2xl font-mono font-bold bg-gray-100 rounded-lg py-3 mb-4">
            {result.tracking_code}
          </p>
          <div className="flex flex-col gap-2">
            <a
              href="/lacak"
              className="text-sm bg-brand-600 hover:bg-brand-700 text-white rounded-lg py-2 font-medium transition"
            >
